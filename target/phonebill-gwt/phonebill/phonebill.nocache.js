    ...
    function installCode(code_0){
      ...
      if (phonebill.__errFn) {
        script.onerror = function(){
          phonebill.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
